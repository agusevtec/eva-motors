...
| Method | Purpose | Input Range | Typical Output |
|--------|---------|-------------|----------------|
| `actBipolar(signed short)` | Bidirectional control | -1000..1000 | PWM with direction, H-bridge signals |
| `actUnipolar(unsigned short)` | Unidirectional control | 0..1000 | PWM duty cycle, analog voltage |
...
Please submit a pull request with driver implementation
